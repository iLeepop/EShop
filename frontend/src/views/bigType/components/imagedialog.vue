<template>
    <el-dialog 
        ...
        <template #header="{ titleId, titleClass }">
            <div class="my-header">
            <h4 :id="titleId" :class="titleClass">商品大类图片更换</h4>
        ...
        <el-form 
            ...
            <el-upload
                ...
                :headers="headers"
                :action="getServiceUrl() + '/admin/bigType/uploadImage'"
...
watch(
    ...
    () => {
        ...
        imageUrl.value = getServiceUrl() + '/image/bigtype/' + formData.value.image
    },
    {
        deep: true,
        immediate: true
...
const handleConfirm = async () => {
    let r = await axios.post('/admin/bigType/save', formData.value)
    let data = r.data
    if(data.code == 0) {
