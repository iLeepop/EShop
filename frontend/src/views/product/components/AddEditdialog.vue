<template>
    <el-dialog
        model-value="AddEditDialogVisible"
        :title="dialogTitle"
        width="50%"
        @close="handleClose">
        <el-form
            ...
            <el-form-item label="商品类别">
                ...
                &nbsp;&nbsp;
                <el-select v-model="form.smallType.id" class="m-2" placeholder="请选择商品小类..." >
                    <el-option
...
const rules=ref({
    ...
    price:[
        ...
        { type: 'number', message: '商品价格是数值类型！',transform: (value) =>
        Number(value) }
    ],
    stock:[
        { required: true, message: '请输入商品库存!' },
        { type: 'number', message: '商品库存是数值类型！',transform: (value) =>
        Number(value) }
    ],
    description:[
        {
