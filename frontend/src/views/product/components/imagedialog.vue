<template>
    <el-dialog 
        model-value="imageDialogTableVisible" 
        :show-close="false" 
        :title="商品图切换"
        width="40%">
        <template #header="{ titleId, titleClass }">
            <div class="my-header">
            <h4 :id="titleId" :class="titleClass">商品图切换</h4>
        ...
        <el-form 
            ...
            <el-upload
                ...
                :headers="headers"
                :action="getServiceUrl() + '/admin/product/uploadImage'"
...
watch(
    ...
    () => {
        ...
        imageUrl.value = getServiceUrl() + '/image/hotImage/' + formData.value.proPic
    },
    {
        deep: true,
        immediate: true
...
const handleImageSuccess = (res) => {
    ...
    formData.value.proPic = res.data.title
}
